...
<body class="bg-[#7C3AED] flex justify-center items-center h-screen">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
        ...
        <form action="{{ route('login.process') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" placeholder="Email" 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" required>
            </div>
            <div class="mb-4">
        ...
        <p class="text-center text-gray-600 mt-6">
            Belum punya akun? <a href="/sign-up" class="text-purple-600 font-semibold hover:underline">Daftar</a>
        </p>
    </div>
</body>
</html>
